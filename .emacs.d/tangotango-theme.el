...
(custom-theme-set-faces
 ...
 '(org-level-3 ((t (:foreground "#6ac214" :weight bold :height 1.0))))
 '(org-level-4 ((t (:foreground "tomato" :weight normal :height 1.0))))
 ...
 '(default ((t (:inherit nil :stipple nil :background "#2e3434" :foreground "#eeeeec" :inverse-video nil :box nil :strike-through nil :overline nil :underline nil :slant normal :weight normal :height 135 :width normal :foundry "JB" :family "JetBrains Mono")))))
