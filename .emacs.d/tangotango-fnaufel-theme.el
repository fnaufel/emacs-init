...
(custom-theme-set-faces
 ...
 '(default ((t (:inherit nil :stipple nil :background "black" :foreground "bisque" :inverse-video nil :box nil :strike-through nil :overline nil :underline nil :slant normal :weight normal :height 135 :width normal :foundry "JB" :family "JetBrains Mono")))))

(provide-theme 'tangotango-fnaufel)
